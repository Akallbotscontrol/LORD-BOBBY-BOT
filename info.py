...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002340341639 -1002894335724 -1002594876658 -1002595679200 -1002742044377').split()]  # For Multiple Id Use One Space Between Each.
